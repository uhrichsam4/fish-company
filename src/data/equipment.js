...
export const TOOLS = [
  ...
  { id: 'tool_axe', name: 'Felling Axe', icon: '🪓', price: 420, tier: 1, shopTier: 1, slot: 'tool',
    desc: 'For trees. The island has opinions about being landscaped.',
    stats: { damage: 22, range: 3.0, rate: 0.85, knockback: 3, chop: 26 } },
  { id: 'tool_axe_steel', name: 'Steel Axe', icon: '⛏️', price: 2100, tier: 2, shopTier: 2, slot: 'tool',
    desc: 'Heavier head, better steel. Fewer swings per trunk.',
    stats: { damage: 34, range: 3.2, rate: 1.0, knockback: 4, chop: 48 } },
